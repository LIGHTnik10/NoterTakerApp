    ...
    return (
      <div className="flex-1 flex items-center justify-center p-4 sm:p-8 animate-fade-in">
        <div className="text-center max-w-lg glass-card rounded-2xl sm:rounded-3xl p-8 sm:p-16 border border-slate-700/50 hover:border-indigo-500/30 transition-all duration-500 hover:shadow-indigo-500/20">
          <div className="text-5xl sm:text-7xl mb-6 sm:mb-8 animate-scale-in hover:scale-110 transition-transform duration-300 cursor-default">
            ✍️
          </div>
  ...
  return (
    <div className="flex-1 flex flex-col animate-fade-in p-4 sm:p-6 lg:p-8">
      <div className="glass-card rounded-2xl sm:rounded-3xl shadow-2xl flex flex-col h-full overflow-hidden hover:shadow-indigo-500/20 transition-all duration-500">
        ...
        <div className="border-b border-slate-700/50 p-4 sm:p-6 lg:p-8 bg-gradient-to-r from-slate-800/50 to-slate-800/30 hover:from-slate-800/60 hover:to-slate-800/40 transition-all duration-300">
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-6 mt-3 sm:mt-4 text-xs sm:text-sm text-slate-400 animate-fade-in">
            ...
            <span className="flex items-center gap-2 font-medium hover:text-slate-300 transition-colors group">
              ...
              {content.length} <span className="hidden sm:inline">characters</span><span className="sm:hidden">chars</span>
            </span>
            {flashcardCount > 0 && (
        ...
        {/* Toolbar */}
        <div className="border-b border-slate-700/50 p-3 sm:p-4 bg-slate-800/20 flex items-center gap-2 flex-wrap">
          <button
        ...
        <div className="flex-1 p-4 sm:p-6 lg:p-8 overflow-hidden">
          {showPreview ? (
            <div
              className="w-full h-full overflow-y-auto text-base sm:text-lg leading-relaxed text-slate-200"
